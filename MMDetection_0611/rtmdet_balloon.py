...
log_level = 'INFO'
load_from = '/root/autodl-tmp/mmdetection-main/work_dirs/rtmdet_balloon/best_coco/bbox_mAP_epoch_230.pth'
resume = False
train_cfg = dict(
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='data/balloon/custom_val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,

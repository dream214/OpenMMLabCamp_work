...
# 模型 config 配置文件
config_file = '/root/autodl-tmp/mmsegmentation/work_dirs/pspnet_r50-d32_4xb2-80k_cityscapes-512x1024/pspnet_r50-d32_4xb2-80k_cityscapes-512x1024.py'

# 模型 checkpoint 权重文件
checkpoint_file = '/root/autodl-tmp/mmsegmentation/work_dirs/pspnet_r50-d32_4xb2-80k_cityscapes-512x1024/iter_80000.pth'
...
# 把每一帧串成视频文件
mmcv.frames2video(temp_out_dir, 'outputs/pred_video.mp4', fps=imgs.fps, fourcc='mp4v')
